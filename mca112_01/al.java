...
public class al extends ly {
   ...
   private void h(cn var1, int var2, int var3, int var4) {
      ...
      List var8 = null;
      if(this.a == js.a) {
         var8 = var1.b((kh)null, cf.b((double)((float)var2 + var7), (double)var3, (double)((float)var4 + var7), (double)((float)(var2 + 1) - var7), (double)var3 + 0.25D, (double)((float)(var4 + 1) - var7)));
      }

      if(this.a == js.b) {
         var8 = var1.a(ge.class, cf.b((double)((float)var2 + var7), (double)var3, (double)((float)var4 + var7), (double)((float)(var2 + 1) - var7), (double)var3 + 0.25D, (double)((float)(var4 + 1) - var7)));
      }

      if(this.a == js.c) {
         var8 = var1.a(dm.class, cf.b((double)((float)var2 + var7), (double)var3, (double)((float)var4 + var7), (double)((float)(var2 + 1) - var7), (double)var3 + 0.25D, (double)((float)(var4 + 1) - var7)));
      }
