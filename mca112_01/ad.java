...
public class ad extends Canvas implements KeyListener, MouseListener, MouseMotionListener, Runnable {
   ...
   private static fa e() {
      ...
      return var0.contains("win")?fa.c:(var0.contains("mac")?fa.d:(var0.contains("solaris")?fa.b:(var0.contains("sunos")?fa.b:(var0.contains("linux")?fa.a:(var0.contains("unix")?fa.a:fa.e)))));
   }
