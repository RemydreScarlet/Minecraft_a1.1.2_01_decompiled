...
public class bc {
   ...
   public boolean c(ly var1, int var2, int var3, int var4) {
      ...
      float var23 = 0.0625F;
      float var24 = 0.625F;
      var21[0] = aj.b((double)(-var22), 0.0D, (double)(-var23));
      var21[1] = aj.b((double)var22, 0.0D, (double)(-var23));
      var21[2] = aj.b((double)var22, 0.0D, (double)var23);
      var21[3] = aj.b((double)(-var22), 0.0D, (double)var23);
   ...
   public boolean j(ly var1, int var2, int var3, int var4) {
      ho var5 = ho.a;
      boolean var6 = var1.c(this.a, var2, var3 + 1, var4, 1);
      boolean var7 = var1.c(this.a, var2, var3 - 1, var4, 0);
      boolean[] var8 = new boolean[]{var1.c(this.a, var2, var3, var4 - 1, 2), var1.c(this.a, var2, var3, var4 + 1, 3), var1.c(this.a, var2 - 1, var3, var4, 4), var1.c(this.a, var2 + 1, var3, var4, 5)};
      if(!var6 && !var7 && !var8[0] && !var8[1] && !var8[2] && !var8[3]) {
         ...
         if(this.d || var6) {
            ...
            var32 = eo.a(var25) * 8.0F / 256.0F;
            var33 = eo.b(var25) * 8.0F / 256.0F;
   ...
   public void a(ly var1, cn var2, int var3, int var4, int var5) {
      ...
      this.a(var1, -0.5D, -0.5D, -0.5D, var1.a(0));
      ...
      this.b(var1, -0.5D, -0.5D, -0.5D, var1.a(1));
      ...
      this.c(var1, -0.5D, -0.5D, -0.5D, var1.a(2));
      var12 = var1.c((nm)var2, var3, var4, var5 + 1);
      if(var12 < var11) {
         var12 = var11;
      }
      ...
      var10.a(var8 * var12, var8 * var12, var8 * var12);
      this.d(var1, -0.5D, -0.5D, -0.5D, var1.a(3));
      ...
      this.e(var1, -0.5D, -0.5D, -0.5D, var1.a(4));
      var12 = var1.c((nm)var2, var3 + 1, var4, var5);
      if(var12 < var11) {
         var12 = var11;
      }
      ...
      var10.a(var9 * var12, var9 * var12, var9 * var12);
      this.f(var1, -0.5D, -0.5D, -0.5D, var1.a(5));
      var10.a();
   }
   ...
   public boolean a(ly var1, int var2, int var3, int var4, float var5, float var6, float var7) {
      ...
      float var27;
      if(this.d || var1.c(this.a, var2, var3 - 1, var4, 0)) {
         var27 = var1.c(this.a, var2, var3 - 1, var4);
         var8.a(var14 * var27, var18 * var27, var22 * var27);
         this.a(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 0));
         var9 = true;
      }

      if(this.d || var1.c(this.a, var2, var3 + 1, var4, 1)) {
         var27 = var1.c(this.a, var2, var3 + 1, var4);
         if(var1.bj != 1.0D && !var1.bn.d()) {
            var27 = var26;
         }

         var8.a(var15 * var27, var19 * var27, var23 * var27);
         this.b(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 1));
         var9 = true;
      }

      if(this.d || var1.c(this.a, var2, var3, var4 - 1, 2)) {
         ...
         this.c(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 2));
         var9 = true;
      }

      if(this.d || var1.c(this.a, var2, var3, var4 + 1, 3)) {
         var27 = var1.c(this.a, var2, var3, var4 + 1);
         if(var1.bk < 1.0D) {
            var27 = var26;
         }
         ...
         var8.a(var16 * var27, var20 * var27, var24 * var27);
         this.d(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 3));
         var9 = true;
      }

      if(this.d || var1.c(this.a, var2 - 1, var3, var4, 4)) {
         ...
         this.e(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 4));
         var9 = true;
      }

      if(this.d || var1.c(this.a, var2 + 1, var3, var4, 5)) {
         var27 = var1.c(this.a, var2 + 1, var3, var4);
         if(var1.bi < 1.0D) {
            var27 = var26;
         }
         ...
         var8.a(var17 * var27, var21 * var27, var25 * var27);
         this.f(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 5));
         var9 = true;
      }
   ...
   public boolean o(ly var1, int var2, int var3, int var4) {
      ...
      int var14 = var1.a(this.a, var2, var3, var4, 2);
      if(var14 < 0) {
         this.c = true;
         var14 = -var14;
      }
      ...
      var5.a(var10 * var13, var10 * var13, var10 * var13);
      var14 = var1.a(this.a, var2, var3, var4, 3);
      if(var14 < 0) {
         this.c = true;
         var14 = -var14;
      }
      ...
      var14 = var1.a(this.a, var2, var3, var4, 4);
      if(var14 < 0) {
         this.c = true;
         var14 = -var14;
      }
      ...
      var5.a(var11 * var13, var11 * var13, var11 * var13);
      var14 = var1.a(this.a, var2, var3, var4, 5);
      if(var14 < 0) {
         this.c = true;
         var14 = -var14;
      }
   ...
   public void a(ly var1, double var2, double var4, double var6, int var8) {
      ...
      double var16 = ((double)var11 + var1.bh * 16.0D) / 256.0D;
      double var18 = ((double)var11 + var1.bk * 16.0D - 0.01D) / 256.0D;
      if(var1.bf < 0.0D || var1.bi > 1.0D) {
         var12 = (double)(((float)var10 + 0.0F) / 256.0F);
         var14 = (double)(((float)var10 + 15.99F) / 256.0F);
      }

      if(var1.bh < 0.0D || var1.bk > 1.0D) {
   ...
   public void c(ly var1, double var2, double var4, double var6, int var8) {
      ...
      double var12 = ((double)var10 + var1.bf * 16.0D) / 256.0D;
      double var14 = ((double)var10 + var1.bi * 16.0D - 0.01D) / 256.0D;
      double var16 = ((double)var11 + var1.bg * 16.0D) / 256.0D;
      double var18 = ((double)var11 + var1.bj * 16.0D - 0.01D) / 256.0D;
      double var20;
      if(this.c) {
         var20 = var12;
         var12 = var14;
   ...
   public void e(ly var1, double var2, double var4, double var6, int var8) {
      ...
      int var10 = (var8 & 15) << 4;
      int var11 = var8 & 240;
      double var12 = ((double)var10 + var1.bh * 16.0D) / 256.0D;
      double var14 = ((double)var10 + var1.bk * 16.0D - 0.01D) / 256.0D;
      double var16 = ((double)var11 + var1.bg * 16.0D) / 256.0D;
      double var18 = ((double)var11 + var1.bj * 16.0D - 0.01D) / 256.0D;
      double var20;
      if(this.c) {
   ...
   public void a(ly var1, float var2) {
      ...
      if(var3 == 0) {
         ...
         this.a(var1, 0.0D, 0.0D, 0.0D, var1.a(0));
         var4.a(var5, var5, var5, var2);
         this.b(var1, 0.0D, 0.0D, 0.0D, var1.a(1));
         var4.a(var7, var7, var7, var2);
         this.c(var1, 0.0D, 0.0D, 0.0D, var1.a(2));
         this.d(var1, 0.0D, 0.0D, 0.0D, var1.a(3));
         var4.a(var8, var8, var8, var2);
         this.e(var1, 0.0D, 0.0D, 0.0D, var1.a(4));
         this.f(var1, 0.0D, 0.0D, 0.0D, var1.a(5));
         var4.a();
         GL11.glTranslatef(0.5F, 0.5F, 0.5F);
      }
