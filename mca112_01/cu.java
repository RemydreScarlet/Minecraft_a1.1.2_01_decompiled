...
public class cu extends ik {
   ...
   public boolean a(cn var1, Random var2, int var3, int var4, int var5) {
      ...
      for(int var19 = 0; var19 <= this.b; ++var19) {
         ...
         double var28 = (double)(eo.a((float)var19 * 3.1415927F / (float)this.b) + 1.0F) * var26 + 1.0D;
         double var30 = (double)(eo.a((float)var19 * 3.1415927F / (float)this.b) + 1.0F) * var26 + 1.0D;
         ...
         for(int var32 = (int)(var20 - var28 / 2.0D); var32 <= (int)(var20 + var28 / 2.0D); ++var32) {
            for(int var33 = (int)(var22 - var30 / 2.0D); var33 <= (int)(var22 + var30 / 2.0D); ++var33) {
               for(int var34 = (int)(var24 - var28 / 2.0D); var34 <= (int)(var24 + var28 / 2.0D); ++var34) {
                  ...
                  if(var35 * var35 + var37 * var37 + var39 * var39 < 1.0D && var1.a(var32, var33, var34) == ly.u.bc) {
