...
public enum er {
   ...
   public final int C;
   // $FF: synthetic field
   private static final er[] D = new er[]{a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x};


   private er(String var1, int var2, String var3, int var4, int var5, int var6, int var7) {
      this.y = var3;
      this.z = var4;
      this.A = var5;
      this.B = var6;
