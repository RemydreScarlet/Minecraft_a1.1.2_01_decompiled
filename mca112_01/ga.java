...
public class ga {
   ...
   private void g(int var1, int var2, int var3) {
      ...
      if(var5 != var4) {
         ...
         if(var5 < var4) {
            ...
            this.d.a(by.a, var7, var4, var8, var7, var5, var8);
         ...
         if(var5 != var10) {
            this.d.a(by.a, var7 - 1, var5, var8 - 1, var7 + 1, var10, var8 + 1);
         }
   ...
   public int a(by var1, int var2, int var3, int var4) {
      return var1 == by.a?this.f.a(var2, var3, var4):(var1 == by.b?this.g.a(var2, var3, var4):0);
   }
   ...
   public void a(kh var1, cf var2, List var3) {
      int var4 = eo.b((var2.b - 2.0D) / 16.0D);
      int var5 = eo.b((var2.e + 2.0D) / 16.0D);
      if(var4 < 0) {
         var4 = 0;
      }
